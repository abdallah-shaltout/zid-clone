<template>
    <section class="py-20 bg-gray-50/50 overflow-hidden">
        <div class="container mx-auto px-4 lg:px-8">
            <!-- Section Header -->
            <div
                class="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-6 mb-12"
            >
                <div>
                    <span
                    ...
                    <h2
                        class="text-3xl lg:text-4xl xl:text-5xl font-bold text-dark-lavender leading-tight"
                    >
                ...
                <div class="flex items-center gap-3">
                    ...
                    >
                        <svg
                            class="w-5 h-5 text-gray-500 group-hover:text-white transition-colors"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            stroke-width="2"
            ...
            <div ref="carouselRef" class="overflow-hidden">
                ...
                >
                    ...
                    >
                        <!-- Quote icon -->
                        <div
                            class="w-10 h-10 rounded-2xl bg-primary/10 flex items-center justify-center mb-6"
                        >
                            <svg
                        ...
                        <!-- Quote text -->
                        <p
                            class="text-dark-lavender/80 text-sm lg:text-base leading-relaxed mb-6 font-medium"
                        >
                            "{{ story.quote }}"
                        </p>
                        ...
                        >
                            ...
                            <div>
                                <div
                                    class="font-semibold text-dark-lavender text-sm"
                                >
                                    {{ story.name }}
                                </div>
...
const stories: Story[] = [
    {
        ...
        photoUrl:
            "https://zid-website.directus.app/assets/a1b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d",
    },
    {
        name: "سارة المطيري",
        ...
        photoUrl:
            "https://zid-website.directus.app/assets/b2c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e",
    },
    {
        name: "خالد العتيبي",
        ...
        photoUrl:
            "https://zid-website.directus.app/assets/c3d4e5f6-a7b8-9c0d-1e2f-3a4b5c6d7e8f",
    },
    {
        name: "نورة القحطاني",
        ...
        photoUrl:
            "https://zid-website.directus.app/assets/d4e5f6a7-b8c9-0d1e-2f3a-4b5c6d7e8f9a",
    },
    {
        name: "فهد الدوسري",
        ...
        photoUrl:
            "https://zid-website.directus.app/assets/e5f6a7b8-c9d0-1e2f-3a4b-5c6d7e8f9a0b",
    },
    {
        name: "لمى السبيعي",
        ...
        photoUrl:
            "https://zid-website.directus.app/assets/f6a7b8c9-d0e1-2f3a-4b5c-6d7e8f9a0b1c",
    },
];
...
const dots = computed(() => {
    return Array.from({
        length: Math.ceil(stories.length / itemsPerPage.value),
    });
});
...
function updateCardWidth() {
    ...
    cardWidth.value =
        (containerWidth - (itemsPerPage.value - 1) * gap) / itemsPerPage.value;
}
