<template>
    <header
        class="fixed top-0 z-50 w-full transition-all duration-300 ease-in-out hover:bg-white"
            ...
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <nav class="hidden lg:flex items-center gap-1">
                    <div
                        ...
                        class="relative"
                        @mouseenter="
                            item.hasDropdown ? openDropdown(item.label) : null
                        "
                    ...
                    >
                        <a
                            ...
                            :class="{
                                'text-primary': activeDropdown === item.label,
                            }"
                        >
                            {{ item.label }}
                            <svg
        ...
        >
            <div class="container mx-auto px-4 py-4 space-y-1">
                ...
                <div class="pt-4 border-t border-gray-100 flex flex-col gap-2">
                    <a
                        href="#"
                        class="block text-center px-4 py-3 text-sm font-medium text-gray-700 border border-gray-200 rounded-xl hover:bg-gray-50"
                    >
                        تسجيل الدخول
                    </a>
                    <a
                        href="#"
                        class="block text-center px-4 py-3 text-sm font-semibold text-white bg-primary rounded-xl"
                    >
                        أنشئ متجرك
                    </a>
                </div>
        ...
        dropdownItems: [
            {
                label: "متجر إلكتروني",
                href: "#",
                description: "أنشئ متجرك الإلكتروني باحترافية",
                icon: "🛒",
            },
            {
                label: "نقاط البيع",
                href: "#",
                description: "نظام متكامل لإدارة المبيعات",
                icon: "💳",
            },
            {
                label: "تطبيق الجوال",
                href: "#",
                description: "تجربة تسوق سلسة على الجوال",
                icon: "📱",
            },
            {
                label: "التسويق",
                href: "#",
                description: "أدوات تسويقية متكاملة",
                icon: "📣",
            },
        ],
    },
        ...
        dropdownItems: [
            {
                label: "قصص النجاح",
                href: "#",
                description: "تجارب تجار ناجحين مع زد",
                icon: "⭐",
            },
            {
                label: "المميزات",
                href: "#",
                description: "اكتشف ما يجعل زد مختلفة",
                icon: "✨",
            },
        ],
    },
        ...
        dropdownItems: [
            {
                label: "للمبتدئين",
                href: "#",
                description: "ابدأ رحلتك في التجارة الإلكترونية",
                icon: "🚀",
            },
            {
                label: "للأعمال المتوسطة",
                href: "#",
                description: "نمو مستدام لعملك",
                icon: "📈",
            },
            {
                label: "للشركات الكبرى",
                href: "#",
        ...
        dropdownItems: [
            {
                label: "المدونة",
                href: "#",
                description: "مقالات ونصائح للتجار",
                icon: "📝",
            },
            {
                label: "مركز المساعدة",
...
function toggleMobileDropdown(label: string) {
    activeMobileDropdown.value =
        activeMobileDropdown.value === label ? null : label;
}
